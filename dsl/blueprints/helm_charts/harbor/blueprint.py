...
helm_chart_namespace = "harbor"
helm_chart_instance_name = "harbor"
...
HarborUser = os.environ['HARBOR_USER']
HarborPassword = os.environ['HARBOR_PASS']
HarborCred = basic_cred(
                    HarborUser,
                    name="Harbor User",
                    type="PASSWORD",
...
class HelmBlueprint(Blueprint):
    ...
    profiles = [Default]
    credentials = [PrismCentralCred, NutanixCred, HarborCred]
