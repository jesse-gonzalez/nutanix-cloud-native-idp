...
helm_chart_instance_name = "keycloak"
...
KeycloakUser = os.environ['KEYCLOAK_USER']
KeycloakPassword = os.environ['KEYCLOAK_PASS']
KeycloakCred = basic_cred(
                    KeycloakUser,
                    name="Keycloak User",
                    type="PASSWORD",
...
class HelmBlueprint(Blueprint):
    ...
    profiles = [Default]
    credentials = [PrismCentralCred, NutanixCred, KeycloakCred]
