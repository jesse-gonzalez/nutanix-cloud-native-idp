...
helm_chart_name = "Rancher"
helm_chart_namespace = "cattle-system"
helm_chart_instance_name = "rancher"
...
RancherUser = os.environ['RANCHER_USER']
RancherPassword = os.environ['RANCHER_PASS']
RancherCred = basic_cred(
                    RancherUser,
                    name="Rancher User",
                    type="PASSWORD",
...
class Default(Profile):
    ...
    # TODO: Rancher is only using nip.io dns.  Wildcard domain needs to be added to ingress after deployment.
...
class HelmBlueprint(Blueprint):
    ...
    profiles = [Default]
    credentials = [PrismCentralCred, NutanixCred, RancherCred]
