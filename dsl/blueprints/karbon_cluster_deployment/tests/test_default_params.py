...
variable_list = [
    ...
    { "value": { "value": os.getenv("ENABLE_ADVANCED_KARBON_MGMT") }, "context": "Default", "name": "enable_advanced_karbon_management" },
    ...
    { "value": { "value": "1.22.9-0" }, "context": "Default", "name": "package_version" }
]
