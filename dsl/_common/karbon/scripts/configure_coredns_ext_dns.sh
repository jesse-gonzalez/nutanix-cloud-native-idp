...
# kubectl rollout restart deployment csi-snapshot-controller -n ntnx-system
# kubectl rollout status deployment csi-snapshot-controller -n ntnx-system -w

# kubectl rollout restart deployment csi-snapshot-webhook -n ntnx-system
# kubectl rollout status deployment csi-snapshot-webhook -n ntnx-system -w

# kubectl rollout restart daemonset nutanix-csi-node -n ntnx-system
# kubectl rollout status daemonset nutanix-csi-node -n ntnx-system -w
